...
Item {
    ...
    function change_values()
    {
        ...
        case 5:
            ...
            wl_calc_val_2 = Math.ceil(Math.random() * 2)
            ...
            if ( wl_calc_val_2*30 == 60 )
            {
                wl_wk_hre = "00"
            }
            else
            {
                wl_wk_hre = (wl_calc_val_2*30)
            }
            ...
            rot_aig_mn.angle = ((wl_calc_val_2 * 360) / 2)
        ...
        case 70:
            ...
            {
                img_temps.source = "../Images/Background/fd1.png"
                stars_back.visible = true
            }
    ...
    function fn_hour_close_activity()
    {
        img_temps.source = "../Images/Background/fd1.png"
        stars_back.visible = true
        fn_close_activity()
